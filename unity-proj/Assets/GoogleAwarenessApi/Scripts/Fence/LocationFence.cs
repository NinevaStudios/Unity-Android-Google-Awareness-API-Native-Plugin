...
namespace NinevaStudios.AwarenessApi
{
	...
	public class LocationFence
	{
		...
		/// <summary>
		/// This fence is momentarily (about 5 seconds) in the TRUE state when the user enters the specified circle.
		///
		...
		/// <summary>
		/// This fence is momentarily (about 5 seconds) in the TRUE state when the user exits the specified circle.
		///
		...
		/// <summary>
		/// This fence is in the TRUE state when the user's location is within the specified circle, and the user has been in the circle for at least the <code>dwellTimeMillis</code> that was specified.
		///
		/// To use this method, your app must declare the android.permission.ACCESS_FINE_LOCATION permission in AndroidManifest.xml, and the user must provide consent at runtime.
		/// </summary>
		/// <param name="latitude">Center latitude of the circle in degrees, between -90 and +90 inclusive.</param>
		/// <param name="longitude">Center longitude of the circle in degrees, between -180 and +180 inclusive.</param>
		/// <param name="radius">Radius defining the circular region, in meters.</param>
		/// <param name="dwellTimeMillis">Minimum dwelling time inside a location before the fence is in the TRUE state. Must be a value greater than or equal to 0L.</param>
		/// <returns>the <see cref="AwarenessFence"/> object representing this fence.</returns>
